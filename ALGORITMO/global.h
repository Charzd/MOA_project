...
typedef struct
{
    ...
    float emisiones;
    int r;
    char tipo; /*L -> Legumbres, M -> Carnes, O -> Otros*/
}plato_fondo;
...
typedef struct
{
    ...
    char *nombre;
    int semana;
    int tipo; /*1,2,3,4,5 -> Lunes, Martes, Miercoles, Jueves, Viernes*/
...
typedef struct
{
    entrada *entradas;
    postre *postres;
    plato_fondo *platos_fondo;
    nutriente *nutrientes;
    dia *dias;
    int nEntradas, nPostres, nFondos, nNutrientes, nDias, nSemanas;
}problem_instance;
...
extern int angle1;
extern int angle2;
extern double *y_under;
extern double *y_over;
